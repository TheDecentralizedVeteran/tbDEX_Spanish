...
\vspace{1\baselineskip}
\end{itemize}
A continuación se muestran ejemplos de escenarios de rampa de entrada (moneda fiduciaria $\rightarrow$ moneda digital) y rampa de salida (moneda digital $\rightarrow$ moneda fiduciaria), usando a Alice como un marcador de posición para representar a cualquier individuo que utilice el protocolo. Para el propósito de este ejemplo, utilizaremos USD, aunque el protocolo no se limita solo a USD.
